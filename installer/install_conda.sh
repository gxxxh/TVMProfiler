...
version=$2
echo "architecture is $architecture version is $version"
...
pip3 install --no-cache-dir psutil 'xgboost<1.6.0' cloudpickle pretrainedmodels cython tensorflow transformers nni six numpy decorator attrs tornado onnx memory_profiler pytest
